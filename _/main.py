...
while True:
    ...
    if option == "1":
        ...
        if option == "2":
            ...
            print()
            print(', '.join(map(str, world.find(world.robot[0], "CHEESE", []))))

        elif option == "6":
            print()
            print(', '.join(map(str, world.find(world.cheese[0], "ROBOT", []))))

        elif option == "7":
            render.renderPath(world)
